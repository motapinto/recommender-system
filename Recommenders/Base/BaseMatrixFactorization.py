...
class BaseMatrixFactorization(Base):
    '''
    This class refers to a Base KNN which uses matrix factorization,
    ...
    def __init__(self, URM_train, verbose=True):
        super(BaseMatrixFactorization, self).__init__(URM_train, verbose=verbose)
        self.use_bias = False
