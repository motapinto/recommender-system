...
from Recommenders.architecture_utils import generate_autoencoder_architecture
    ...
    def save_model(self, folder_path, file_name = None, is_earlystopping_format = False):
        ...
        if not is_earlystopping_format:
            ...
            shutil.make_archive(
              ...
              'zip',                            
              root_dir = folder_path + file_name + '/',     
              base_dir = None)
