...
class RP3betaRecommender(BaseItemSimilarityMatrixRecommender):
    ...
    def __str__(self):
        return 'RP3beta(alpha={}, beta={}, min_rating={}, topk={}, implicit={}, normalize_similarity={})'.format(
            self.alpha, self.beta, self.min_rating, self.topK, self.implicit, self.normalize_similarity)

    def fit(self, alpha=1.028657, beta=0.692638, min_rating=0, topK=563, implicit=False, normalize_similarity=True):
        self.alpha = alpha
        self.beta = beta
