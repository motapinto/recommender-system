...
from Recommenders.Base.BaseItemSimilarityMatrixRecommender import BaseItemSimilarityMatrixRecommender
...
class P3alphaRecommender(BaseItemSimilarityMatrixRecommender):
    ...
    def __str__(self):
        return 'P3alpha(alpha={}, min_rating={}, topk={}, implicit={}, normalize_similarity={})'.format(
            self.alpha, self.min_rating, self.topK, self.implicit, self.normalize_similarity)

    def fit(self, topK=134, alpha=0.7714, min_rating=0, implicit=False, normalize_similarity=False):
        self.topK = topK
        self.alpha = alpha
        ...
        #axis is still 1 because i transposed before the normalization
