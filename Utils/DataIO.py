...
def json_not_serializable_handler(o):
    ...
    raise TypeError(f'json_not_serializable_handler: object {type(o)} is not serializable.')
        ...
        try:
            ...
            for file_name in dataFile.namelist():
                ...
                if file_extension == 'csv':
                    ...
                    raise Exception(f'Attribute type not recognized for: {decompressed_file_path} of class: {file_extension}')
